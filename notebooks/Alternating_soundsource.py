...
new_rate_sort = np.take_along_axis(
    new_rate,
    idx_sorted[:, None, :],
    axis=2
)
...
for speaker in range(4):
    plt.plot(bins_plot/1000, new_rate_bs_smooth[cell,:, speaker], label=["Closest", 'Second Closest', 'Second Farthest', 'Farthest'])
    plt.xlim(-0.2, 1)
